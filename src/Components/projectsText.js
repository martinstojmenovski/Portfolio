const project1 = (
  <div className="container1">
    <a href="https://martinstojmenovski.github.io/Friends/" target="_blank">
...
const project2 = (
  <div className="container2">
    <a href="https://the-javawockeez.github.io/Ventilation/" target="_blank">
      <div className="project2">
      <h3>Ventilation</h3>
      <p>The intent of this website is to be a social
...
const project3 = (
  <div className="container3">
    <a href="https://martinstojmenovski.github.io/React-Marvel-api/" target="_blank">
      <div className="project3">
      <h3>Marvel</h3>
      <p>Interactive application allows you to read the description
...
const project4 = (
  <div className="container4">
    <a href="https://martinstojmenovski.github.io/portfolio/index.html#aboutMe" target="_blank">
